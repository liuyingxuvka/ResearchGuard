...
CONTRACT = {
    "contract_id": "researchguard.member-admission.logicguard.v1",
    "member_id": "logicguard",
    "applicability": (
        "argument support, warrants, assumptions, rebuttals, wording licence, "
        "artifact reasoning structure, or LogicGuard-owned source-library synthesis"
    ),
    "forbidden_conditions": (
        "primary evidence discovery, temporal/storyline reconstruction, or finite "
