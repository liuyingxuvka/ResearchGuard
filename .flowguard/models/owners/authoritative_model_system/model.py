...
PROTECTED_FAILURE_IDS = (
    "researchguard:authoritative_model_system:definition-missing",
    "researchguard:authoritative_model_system:binding-missing",
    "researchguard:authoritative_model_system:evidence-stale",
)
KNOWN_GOOD_CASE_ID = "native:authoritative_model_system:current-good"
KNOWN_BAD_CASE_IDS = (
    "native:authoritative_model_system:definition-missing",
    "native:authoritative_model_system:binding-missing",
    "native:authoritative_model_system:evidence-stale",
)
...
def check_blueprint_inputs(root: str | Path) -> dict[str, Any]:
    ...
    manifest_path = root_path / ".flowguard/models/regression-manifest.json"
    definition_path = root_path / ".flowguard/structure/project-definition.json"
    mesh_path = root_path / ".flowguard/models/owners/authoritative_model_system/semantic_model_mesh.json"
