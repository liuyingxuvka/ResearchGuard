# SourceGuard Native Oracle Code Alignment

## Purpose

Define the single current finding identity that binds SourceGuard's
content-anchor oracle to its native depth owner while preserving fail-closed
